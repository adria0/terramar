...
START = join(MP3_PATH,'xxxx_start.mp3')
QUESTION = join(MP3_PATH,'xxxx_question.mp3')
NEXT = join(MP3_PATH,'xxxx_next_song.mp3')
ANSWER = join(MP3_PATH,'xxxx_answer.mp3')
ROLL = join(MP3_PATH,'xxxx_roll.mp3')
OK = join(MP3_PATH,'xxxx_ok.mp3')
KO = join(MP3_PATH,'xxxx_ko.mp3')
